...
# The new footer HTML - matching the layout from image 3
# Mobile: 2 columns
#   Left:  Company (green link) -> About, Careers, Contact, Compliance
#   Right: Solutions (green link) -> [gap] -> Content (green) -> News
# Desktop: 4 columns (Company | Solutions | Content | Legal)
# Below: disclaimer, then copyright + legal links

new_footer = '''  <footer class="footer">
    <div class="container">
      <!-- DESKTOP NAV: 4-column grid (hidden on mobile) -->
      <div class="footer-grid footer-desktop-only">
        ...
        <div>
          <div class="footer-col-title" data-i18n="footer_col1_title">Empresa</div>
        ...
        <div>
          <div class="footer-col-title" data-i18n="footer_col2_title">Solu\u00e7\u00f5es</div>
          <div class="footer-links">
            <a href="index.html#solutions" data-i18n="footer_col2_1">Pagamentos internacionais</a>
            <a href="index.html#solutions" data-i18n="footer_col2_2">Tesouraria global</a>
          </div>
        </div>
        <div>
          <div class="footer-col-title" data-i18n="footer_col3_title">Conte\u00fados</div>
          <div class="footer-links">
            <a href="news.html" data-i18n="footer_col3_1">Blog</a>
          </div>
        </div>
        <div>
          <div class="footer-col-title" data-i18n="footer_col4_title">Legal</div>
          <div class="footer-links">
            <a href="privacy-policy.html" data-i18n="footer_col4_1">Pol\u00edtica de privacidade</a>
      ...
      <!-- MOBILE NAV: 2-column layout matching reference design (hidden on desktop) -->
      <div class="footer-mobile-only">
        ...
        <div class="footer-mobile-grid">
          <div class="footer-mobile-col">
            <a href="index.html#company" class="footer-col-title" data-i18n="footer_col1_title">Company</a>
            <div class="footer-links">
          ...
          <div class="footer-mobile-col">
            <a href="index.html#solutions" class="footer-col-title" data-i18n="footer_col2_title">Solutions</a>
            <div class="footer-links" style="margin-bottom: 2rem;"></div>
            <div class="footer-col-title" data-i18n="footer_col3_title">Content</div>
            <div class="footer-links">
