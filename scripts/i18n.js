document.addEventListener("DOMContentLoaded", () => {
  ...
  const translationsData = {
    pt: {
      ...
      "solution_body": "A BLOXtrade conecta stablecoins, moeda local e liquidação global em uma infraestrutura pensada para empresas que precisam mover recursos com agilidade, controle e escala. Em vez de depender de uma cadeia bancária lenta, sua operação passa a contar com rotas mais eficientes para entrada, saída, conversão e settlement.",
    ...
    en: {
      ...
      "hero_headline": "Global payments in minutes.",
      "hero_subheadline": "Pay, receive, and settle international transactions in minutes.",
      ...
      "solution_body": "BLOXtrade connects stablecoins, local currency rails, and global settlement in infrastructure built for businesses that need speed, control, and scale. Instead of relying on slow banking chains, your operation gains access to more efficient routes for on-ramp, off-ramp, conversion, and settlement.",
