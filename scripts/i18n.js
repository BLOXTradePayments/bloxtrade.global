document.addEventListener("DOMContentLoaded", () => {
  ...
  const translationsData = {
    pt: {
      ...
      "solution_title": "Uma camada financeira<br>moderna para operações<br>internacionais.",
    ...
    en: {
      ...
      "solution_title": "A modern financial layer<br>for international<br>operations.",
