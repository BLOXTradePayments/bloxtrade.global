document.addEventListener("DOMContentLoaded", () => {
  ...
  const translationsData = {
    pt: {
      ...
      "solution_title": "Uma <span style=\"color: #81CD4E; font-weight: 900;\">camada financeira moderna</span><br><span style=\"font-family: var(--font-family); font-size: clamp(1.25rem, 3vw, 2rem); font-weight: 400; text-transform: none; letter-spacing: 0; display: block; margin-top: 0.5rem;\">para operações internacionais.</span>",
    ...
    en: {
      ...
      "solution_title": "A <span style=\"color: #81CD4E; font-weight: 900;\">modern financial</span> layer<br><span style=\"font-family: var(--font-family); font-size: clamp(1.25rem, 3vw, 2rem); font-weight: 400; text-transform: none; letter-spacing: 0; display: block; margin-top: 0.5rem;\">for international operations.</span>",
