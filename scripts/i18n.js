document.addEventListener("DOMContentLoaded", () => {
  ...
  const translationsData = {
    ...
    en: {
      ...
      "insights_card1": "Hong Kong Blockchain Association (HKBA) · Family Offices Summit",
      "insights_card2": "Payments by the Beach",
  ...
  function applyTranslations(translations) {
    ...
    elements.forEach(el => {
      ...
      if (translations[key]) {
        // If element is an input or textarea placeholder
