document.addEventListener("DOMContentLoaded", () => {
  ...
  const translationsData = {
    ...
    es: {
      ...
      "hero_subheadline": "Pague, reciba, convierta e liquide operações internacionais com stablecoins e moeda local, com liquidação em minutos, operação 24/7 e alcance global para empresas que não podem depender do ritmo dos bancos tradicionais.",
      "hero_support_line": "8 años de experiencia · 100 mil transacciones · USD 2,5 mil millones transaccionados · operação em mais de 40 países",
      ...
      "problem_title": "Las operaciones globales exigen más velocidad que los bancos.",
      "problem_body": "Las empresas con operaciones internacionales pierden tiempo, margen y previsibilidad con processos bancários lentos, múltiplos intermediários e janelas de liquidação restritas.",
      "problem_bullet_1": "Liquidación en minutos, no en días",
      ...
      "solution_eyebrow": "La solução",
      "solution_title": "Una capa financeira<br>moderna para operações<br>internacionais.",
      "solution_body": "BLOXtrade conecta stablecoins, moeda local e liquidação global em uma infraestrutura pensada para empresas que precisam mover recursos com agilidade, controle e escala. Em vez de depender de uma cadeia bancária lenta, sua operação passa a contar com rotas mais eficientes para entrada, saída, conversão e settlement.",
      ...
      "services_card5_title": "Financiación del comercio exterior",
      "services_card5_text": "Apoye la importación y exportación con soluciones financieras más rápidas y adaptadas a la nueva economía global.",
      "services_card6_title": "API para pagos globales",
      "services_card6_text": "Añada pagos transfronterizos y flujos con stablecoins a su producto con una integración sencilla para equipos técnicos.",
      "howitworks_eyebrow": "Cómo funciona",
      "howitworks_title": "Desde el onboarding hasta la liquidación, en un flujo mais direto.",
      "howitworks_step1_title": "Abra su operação global",
      "howitworks_step1_text": "Onboarding 100% digital e acesso à estrutura para operar USD, EUR e USDT sem burocracia desnecessária.",
      "howitworks_step2_title": "Configure la operación",
      "howitworks_step2_text": "Defina el destinatario, el monto y la moneda. BLOXtrade direciona a transação pela rota mais eficiente em custo e velocidade.",
      ...
      "infra_body": "Nossa infraestrutura foi desenhada para suportar pagamentos globais de alto volume e alta velocidade, com rede de liquidez, on/off-ramp, settlement contínuo e API pronta para produtos financeiros e operações cross-border.",
      "infra_bullet_1": "Liquidación quase instantânea em diversos pares",
      "infra_bullet_2": "Envio direto para contas bancárias em mercados estratégicos, incluindo EUA, China e América Latina",
      "infra_bullet_3": "Infraestructura lista para desarrolladores",
      "infra_bullet_4": "Plataforma intuitiva para la gestión financiera global",
      "comparison_eyebrow": "Comparativa",
      "comparison_title": "SWIFT fue diseñado para otra era.",
      ...
      "compliance_title": "Estructura global, operação alinhada ao ambiente regulatório.",
      "compliance_body": "A BLOXtrade atua em conformidade com o Marco Legal dos Ativos Virtuais no Brasil, incluindo a Lei 14.478/2022 e obrigações fiscais aplicáveis, com operações em moeda fiduciária realizadas por instituições financeiras ou de pagamento autorizadas.",
      "compliance_support": "La seguridad, la transparencia y el cumplimiento regulatorio no son complementos de la operação. Son parte de la infraestructura.",
      "partners_eyebrow": "Ecosistema",
      "partners_title": "SOCIOS",
      "partners_body": "A BLOXtrade opera conectada a parceiros relevantes em custódia, compliance, pagamentos, liquidez e infraestrutura financeira, reforçando a robustez do seu ecossistema operacional.",
      "insights_eyebrow": "Contenidos",
      "insights_title": "NOTICIAS",
      "insights_body": "Guías, análisis y contenidos prácticos para empresas que operan entre monedas, mercados y jurisdicciones.",
      "insights_card1": "Asociación de Blockchain de Hong Kong (HKBA) · Family Offices Summit",
      "insights_card2": "Payments by the Beach",
      "insights_card3": "BLOXtrade se expande globalmente",
      "cta_title": "Su operación global no debería moverse a la velocidad de los bancos.",
      "cta_body": "Fale com a BLOXtrade para estruturar pagamentos, recebimentos e liquidação internacional com mais velocidade, eficiência e controle.",
      "footer_col1_title": "Empresa",
      ...
      "footer_col2_2": "Tesouraria global",
      "footer_col2_3": "Financiación comercial",
      "footer_col2_4": "API",
      ...
      "contact_message_placeholder": "¿Cómo podemos ayudar a su operação global?",
      "contact_submit_btn": "Enviar mensaje",
      "privacy_title": "Política de Privacidad",
      "privacy_content": "BLOXtrade se compromete a proteger su privacidad. Esta política describe cómo recopilamos, usamos y protegemos sus datos personales de acuerdo con las leyes vigentes. El documento completo estará disponible próximamente.",
      "terms_title": "Términos de Uso",
      "terms_content": "Estos términos regulan el acesso e o uso da plataforma BLOXtrade. Al utilizar nossos serviços, você concorda com nossas diretrizes operacionais, de segurança e compliance. El documento completo estará disponible próximamente.",
      ...
      "news_subheadline": "Siga las novedades, guías prácticas e insights sobre el mercado de pagos transfronterizos e infraestructura web3.",
      ...
      "careers_option_level_estagio": "Prácticas / Becario",
      "careers_option_level_junior": "Junior",
      ...
      "careers_option_source_instagram": "Instagram",
      "careers_option_source_indicacao": "Recomendación",
      "careers_option_source_linkedin": "LinkedIn",
      ...
      "careers_dropzone_text": "Arrastre y suelte su currículum en PDF aqui o haga clic para seleccionar",
      ...
      "careers_submit_btn": "Enviar candidatura",
      "careers_lgpd_note": "Sus datos se utilizarán exclusivamente con fines de reclutamiento y selección, de conformidad con la normativa de protección de datos.",
      "careers_success_title": "¡Candidatura Enviada!",
      "careers_success_text": "Agradecemos su interés en formar parte de nuestro equipo. Analizaremos su perfil detalladamente y nos pondremos en contacto si hay sinergia con nuestras vacantes.",
