document.addEventListener("DOMContentLoaded", () => {
  ...
  const translationsData = {
    pt: {
      ...
      "services_title": "Soluções<br><span style=\"font-family: var(--font-family); font-size: clamp(1.25rem, 3vw, 2rem); font-weight: 400; text-transform: none; letter-spacing: 0; display: block; margin-top: 0.5rem; line-height: 1.3;\">para operações que já pensam globalmente.</span>",
    ...
    en: {
      ...
      "services_title": "Solutions<br><span style=\"font-family: var(--font-family); font-size: clamp(1.25rem, 3vw, 2rem); font-weight: 400; text-transform: none; letter-spacing: 0; display: block; margin-top: 0.5rem; line-height: 1.3;\">for companies already operating globally.</span>",
