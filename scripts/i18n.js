document.addEventListener("DOMContentLoaded", () => {
  ...
  const translationsData = {
    pt: {
      ...
      "hero_headline": "Pagamentos<br>globais <span style=\"color: #61b12f; font-weight: 700;\">em minutos!</span>",
      ...
      "solution_title": "Uma <span style=\"color: #61b12f; font-weight: 900;\">camada financeira moderna</span><br><span style=\"font-family: var(--font-family); font-size: clamp(1.25rem, 3vw, 2rem); font-weight: 400; text-transform: none; letter-spacing: 0; display: block; margin-top: 0.5rem;\">para operações internacionais.</span>",
      "solution_body": "A BLOXtrade é uma orquestradora de pagamentos internacionais B2B redefinindo o movimento do capital global. A empresa opera como uma camada de infraestrutura unificada conectando negócios a provedores de liquidez e modernos trilhos financeiros, aproveitando as stablecoins para eliminar as fricções do sistema bancário tradicional.<br><br>Ao combinar agilidade e compliance, a BLOXtrade otimiza as operações de câmbio por meio de liquidação instantânea e redução significativa de custos, incluindo taxas SWIFT, ao mesmo tempo em que mantém a segurança regulatória exigida pelo mercado corporativo.<br><br>Com sede em Delaware, a BLOXtrade utiliza ativos digitais como ferramentas práticas de tesouraria, garantindo que o valor se mova através das fronteiras de forma rápida, transparente e eficiente.",
      "services_title": "Soluções para operações que já pensam globalmente.",
      ...
      "services_card4_title": "On-ramp e off-ramp",
      "services_card4_text": "Conecte moeda local e stablecoins em uma infraestrutura preparada para fluxos globais.",
      ...
      "howitworks_title": "Do onboarding à liquidação, em um fluxo mais direto.",
      ...
      "partners_title": "Conectada a parceiros estratégicos de infraestrutura e mercado.",
      ...
      "insights_title": "Inteligência para operações internacionais.",
      "insights_body": "Guias, análises e conteúdos práticos para empresas que operam entre moedas, mercados e jurisdições.",
      "insights_card1": "Pagamentos internacionais com stablecoins",
      "insights_card2": "Como funcionam os pagamentos no Brasil",
      "insights_card3": "Guia para pagamentos bancários à China",
    ...
    en: {
      ...
      "hero_headline": "Global<br>transactions <span style=\"color: #61b12f; font-weight: 700;\">in minutes!</span>",
      ...
      "metrics_title": "Infrastructure proven<br>at real scale.",
      ...
      "solution_title": "A <span style=\"color: #61b12f; font-weight: 900;\">modern financial</span> layer<br><span style=\"font-family: var(--font-family); font-size: clamp(1.25rem, 3vw, 2rem); font-weight: 400; text-transform: none; letter-spacing: 0; display: block; margin-top: 0.5rem;\">for international operations.</span>",
      "solution_body": "BLOXtrade is a B2B international payments orchestrator redefining the movement of global capital. The company operates as a unified infrastructure layer connecting businesses to liquidity providers and modern financial rails, leveraging stablecoins to eliminate the frictions of the traditional banking system.<br><br>By combining agility and compliance, BLOXtrade optimizes foreign exchange operations through instant settlement and significant cost reduction, including SWIFT fees, while maintaining the regulatory security required by the corporate market.<br><br>Headquartered in Delaware, BLOXtrade uses digital assets as practical treasury tools, ensuring value moves across borders in a fast, transparent, and efficient way.",
      "services_title": "Solutions for companies already operating globally.",
      ...
      "services_card4_title": "On-ramp and off-ramp",
      "services_card4_text": "Connect local currency and stablecoins through infrastructure built for global flows.",
      "services_card5_title": "Trade finance",
      ...
      "howitworks_title": "From onboarding to settlement in a more direct flow.",
      ...
      "partners_title": "Connected to strategic market and infrastructure partners.",
      ...
      "insights_title": "Intelligence for international operations.",
      "insights_body": "Guides, analysis, and practical content for companies operating across currencies, markets, and jurisdictions.",
      "insights_card1": "International payments with stablecoins",
      "insights_card2": "How payments work in Brazil",
      "insights_card3": "Guide to bank payments into China",
