document.addEventListener("DOMContentLoaded", () => {
  ...
  const translationsData = {
    pt: {
      ...
      "solution_body_1": "A BLOXtrade é uma orquestradora de pagamentos internacionais B2B redefinindo o movimento do capital global. A empresa opera como uma camada de infraestrutura unificada conectando negócios a provedores de liquidez e modernos trilhos financeiros, aproveitando as stablecoins para eliminar as fricções do sistema bancário tradicional.",
      "solution_body_2": "Ao combinar agilidade e compliance, a BLOXtrade otimiza as operações de câmbio por meio de liquidação instantânea e redução significativa de custos, incluindo taxas SWIFT, ao mesmo tempo em que mantém a segurança regulatória exigida pelo mercado corporativo.",
      "services_title": "Soluções<br><span style=\"font-family: var(--font-family); font-size: clamp(1.25rem, 3vw, 2rem); font-weight: 400; text-transform: none; letter-spacing: 0; display: block; margin-top: 0.5rem; line-height: 1.3;\">para operações que já pensam<br>globalmente.</span>",
    ...
    en: {
      ...
      "services_title": "Solutions<br><span style=\"font-family: var(--font-family); font-size: clamp(1.25rem, 3vw, 2rem); font-weight: 400; text-transform: none; letter-spacing: 0; display: block; margin-top: 0.5rem; line-height: 1.3;\">for companies already<br>operating globally.</span>",
