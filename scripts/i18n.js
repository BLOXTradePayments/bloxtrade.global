document.addEventListener("DOMContentLoaded", () => {
  ...
  const translationsData = {
    pt: {
      ...
      "compliance_body": "Infraestrutura fintech de última geração que combina segurança de nível institucional, estruturas avançadas de compliance e capacidades de pagamentos globais integradas — garantindo que cada transação opere sob os mais altos padrões regulatórios e operacionais internacionais.",
      ...
      "footer_copyright": "©2026. ALL RIGHTS RESERVED. BLOXTRADE TECHNOLOGY INC.",
      ...
      "careers_form_title": "Formulário de Candidatura",
      ...
      "careers_success_title": "Candidatura Enviada com Sucesso!",
    ...
    en: {
      ...
      "careers_page_subtitle": "Be part of our crew: we're always looking for committed people who are passionate about what they do.",
      "careers_form_title": "Application Form",
      "careers_sec_personal": "Personal Information",
      "careers_label_name": "Full Name",
      "careers_placeholder_name": "Enter your full name",
      "careers_label_email": "E-mail",
      "careers_placeholder_email": "you@company.com",
      "careers_label_phone": "Phone / WhatsApp",
      "careers_placeholder_phone": "Enter your phone number",
      "careers_label_city": "City and Country",
      "careers_placeholder_city": "Ex: New York, USA",
      "careers_sec_about": "About You",
      "careers_label_area": "Area of interest",
      "careers_option_area_default": "Select an area...",
      "careers_option_area_marketing": "Marketing",
      "careers_option_area_comercial": "Sales / Business",
      "careers_option_area_design": "Design",
      ...
      "careers_lgpd_note": "Your data will be used exclusively for recruitment and selection purposes, in compliance with applicable data protection regulations.",
      "careers_success_title": "Application Submitted Successfully!",
      "careers_success_text": "Thank you for your interest in joining our team. We will review your application carefully and contact you if there is synergy with our open roles.",
